...
function ComicViewer(comic: {
  id: string;
  description: string;
  imageUrl: string;
  variantUrl: string;
  prevComicImageUrl: string;
  nextComicImageUrl: string;
  latest: string;
}) {
  let nextComic = null;
  let prevComic = null;
  ...
  useEffect(() => {
    ...
    const copyHandler = (e: Event) => {
      ...
      navigator.clipboard.writeText(
        "https://www.willyandfroggy.com/BR/" + comic.id
      );
    };
  ...
  return (
    <div className="comic-viewer-container">
      ...
      <div className="comic-viewer-ad-buttons">
        <a href={comic.variantUrl} className="comic-viewer-ad-button">
          Buy Print
        </a>
        <a
          href="https://shop.willyandfroggy.com/products/tip-jar"
          className="comic-viewer-ad-button"
        >
          Tip Jar
        </a>
      </div>
      <a
        ...
        href="#"
        className="comic-viewer-share-link"
      >
      ...
      <div
        className="preloadingComics"
        style={{ visibility: "hidden", position: "absolute", top: "0" }}
      >
        <Image
          src={comic.prevComicImageUrl}
          layout="constrained"
          width={880}
          height={880}
